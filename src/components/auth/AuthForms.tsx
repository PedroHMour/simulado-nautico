        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
          <div className="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden border border-gray-200">
            <div className="bg-blue-900 p-6 text-center">
                ...
                <p className="text-blue-200 text-sm mt-1">Digite seu e-mail cadastrado</p>
            </div>
            <div className="p-8">
                {msgSucesso ? (
                    <div className="text-center">
                        ...
                        <button onClick={() => setModoRecuperacao(false)} className="text-blue-600 font-bold hover:underline">
                            Voltar para o Login
                        </button>
                    </div>
                ) : (
                    <form onSubmit={handleEnviarRecuperacao} className="space-y-4">
                        <div className="space-y-1">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    type="email"
                                    required
                                    className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 text-gray-900 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none"
                        ...
                        <button
                            ...
                            className="w-full bg-blue-900 text-white font-bold py-3.5 rounded-xl hover:bg-blue-800 transition-colors flex items-center justify-center gap-2"
                        >
                            {loadingRecuperacao ? <Loader2 className="animate-spin" /> : "Enviar Link"}
                        </button>
                        <button 
                            type="button" 
                            onClick={() => setModoRecuperacao(false)}
                            className="w-full flex items-center justify-center gap-2 text-gray-500 font-bold text-sm mt-4 hover:text-gray-800"
                        >
      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden border border-gray-200">
        ...
        <div className="p-8">
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            {/* BOTÃO ESQUICI MINHA SENHA ADICIONADO AQUI */}
            {modo === 'login' && (
                <div className="flex justify-end">
                    <button type="button" onClick={() => setModoRecuperacao(true)} className="text-xs text-blue-600 font-bold hover:underline">
                        Esqueci minha senha
                    </button>
                </div>
            )}
